...
#### TODO
- Pt2.0, dynamo + inductor
    - JIT compiler backend to optimize the execution graph generated by torch dynamo
    - Use triton to generate gpu code
...
- JIT + JAX + XLA
    - XLA 
        ...
        - JIT compiles the TensorFlow graph into a sequence of computation kernels generated specifically for the given model. Fusion is the XLA’s single most important optimization. 
        - The concept is pretty close to torch inductor
    - JAX
        - AutoGrad + XLA
...
- Parallelism & Sharding: FSDP & PJIT 
    ...
    https://github.com/fmars/pbag/blob/master/pytorch/autograd.py 
    DDP
    https://github.com/fmars/pbag/blob/master/pytorch/ddp.py 
    FSDP 
    https://engineering.fb.com/2021/07/15/open-source/fsdp/ 
    GSPMD & gshard
    PJIT
